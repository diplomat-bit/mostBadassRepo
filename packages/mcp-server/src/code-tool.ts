// REPOSITORY SOURCE: diplomat-bit/jocall3-node | PATH: diplomat-bit-jocall3-node-fae6abf/packages/mcp-server/src/code-tool.ts
================================================================================
...
const prompt = `Runs JavaScript code to interact with the Jocall3 API.
...
export function codeTool(): McpTool {
  ...
  const handler = async (client: Jocall3, args: any): Promise<ToolCallResult> => {
    ...
    const res = await fetch(codeModeEndpoint, {
      ...
      body: JSON.stringify({
        project_name: 'jocall3',
        code,
        intent,
        client_opts: { environment: (readEnv('JOCALL3_ENVIRONMENT') || undefined) as any },
