// REPOSITORY SOURCE: diplomat-bit/ai-banking-swarm-roster | PATH: diplomat-bit-ai-banking-swarm-roster-20297ff/components/EditorCanvas.tsx
================================================================================
...
================================================================================
// APPENDED FROM REPO: diplomat-bit/autoomousai | ORIGINAL PATH: diplomat-bit-autoomousai-f4d320c/components/EditorCanvas.tsx
================================================================================
...
================================================================================
// APPENDED FROM REPO: diplomat-bit/usa | ORIGINAL PATH: diplomat-bit-usa-d72fd59/components/EditorCanvas.tsx
================================================================================
    ...
    <div className="flex flex-col h-full bg-gray-850 relative">
      ...
      <div className="absolute bottom-6 right-6 flex flex-col gap-3">
        <button
          ...
          className={`rounded-full p-4 shadow-lg transition-transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-offset-gray-850 ${
            isSwarmModeActive ? 'bg-orange-600 animate-pulse text-white ring-orange-400' : 'bg-gray-700 text-gray-300 ring-gray-600'
          }`}
          title={isSwarmModeActive ? "Swarm Mode Active (Triggers every 30s)" : "Enable Swarm Mode (Autonomous Loop)"}
          aria-label="Toggle Swarm Mode"
        >
           <SparklesIcon className={`h-6 w-6 ${isSwarmModeActive ? 'animate-spin-slow' : ''}`} />
           {isSwarmModeActive && <span className="absolute -top-1 -right-1 bg-red-500 text-[10px] px-1 rounded-full animate-bounce">ON</span>}
        </button>
        <button
          onClick={onAdvancedAiEdit}
          className="bg-indigo-600 text-white rounded-full p-4 shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-4 focus:ring-offset-gray-850 focus:ring-indigo-500 transition-transform hover:scale-110"
